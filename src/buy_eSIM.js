...
const BuyESIM = () => {
	...
	useEffect(() => {
		if (regionIcons && Object.keys(regionIcons).length > 0) {
			//console.log("Regions Loaded:", Object.keys(regionIcons)); 
	...
	const handleRegionClick = (region) => {
		...
		//console.log("Filtered Packages for Region:", region, matchingPackages);
	...
	useEffect(() => {
		if (selectedCountry) {
			...
			//console.log("Filtered Packages for Country:", selectedCountry, packages); // Debugging
	...
	//console.log("Region Icons:", regionIcons);
	//console.log("Selected Region:", selectedRegion);
	//console.log("Filtered Region Packages:", filteredRegionPackages);
